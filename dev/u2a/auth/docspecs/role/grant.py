...
R_ROLE_GRANT_SUCCESS = {**RESPONSE_BASE, **{
  "example": {
    "code": 200,
    "data": {
...
ROLE_GRANT = {
  ...
  "security": [{"Bearer": []}],
  "description": """
  Добавляет существующему в системе пользователю роль. После добавления все токены пользоватля инвалидируются.
  ...
  "responses": {
    ...
    "451": {
      "description":
"""
  Если роль или пользователь с идентификатором не существуют или же если уже существует пара user_id:role_id,
  т.е. роль уже присвоена пользователю
""",
      "schema": E_ROLE_CONSTRAINTS_VALIDATION
    },
    "452": {
